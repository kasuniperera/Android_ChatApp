...
public class GroupChatActivity extends AppCompatActivity {
    ...
    private String currentGroupName, currentuserID, currentUseName, currentDate, currentTime;
    ...
    private void GetUserInfo(){
        UsersRef.child(currentuserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    currentUseName = dataSnapshot.child("name").getValue().toString();
                }
            }
    ...
    private void SaveMessageInfoToDatabase(){
        ...
        if (TextUtils.isEmpty(message)){
            ...
            currentDate = currenDateFormat.format(calForDate.getTime());


            Calendar  calForTime =Calendar.getInstance();
            SimpleDateFormat currenTimeFormat =new SimpleDateFormat("hh:mm a");
            currentTime = currenTimeFormat.format(calForTime.getTime());
            ...
            messageInfoMap.put("name",currentUseName);
